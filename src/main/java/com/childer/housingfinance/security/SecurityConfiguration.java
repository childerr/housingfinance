...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .and()
                .apply(new JwtConfigurer(jwtService, accountsService));
        //@formatter:on
    }
...
//                //.anyRequest().authenticated()
//                .and()
//                .addFilterBefore(new JwtAuthenticationFilter(jwtService, accountsService), BasicAuthenticationFilter.class); // jwt token 필터를 id/password 인증 필터 전에 넣는다
//    }
